...
(function () {
  ...
  var I18N = {
    de: {
      ...
      "hero.badge": "Version 1.6.0 — Kostenlos &amp; Unbegrenzt",
      ...
      "news.r1Title": "Release 1.6.0",
      "news.r1Badge": "Aktuell",
      "news.r1Desc": "Ab dem Release 1.6.0 wurden die Einschränkungen für die private Nutzung aufgehoben. Es freut uns, den weltweit über <strong class=\"font-semibold\">10.000 WirthSim-Anwendern</strong> unser Produkt nun uneingeschränkt zur Verfügung zu stellen.",
      ...
      "download.cardSub": "Version 1.6.0 · Freeware",
    ...
    en: {
      ...
      "nav.news": "News",
      "nav.download": "Download",
      "hero.badge": "Version 1.6.0 — Free &amp; Unlimited",
      ...
      "news.r1Desc": "As of release 1.6.0, the restrictions for private use have been lifted. We are pleased to now offer our product without limitations to over <strong class=\"font-semibold\">10,000 WirthSim users</strong> worldwide.",
    ...
    fr: {
      ...
      "hero.badge": "Version 1.6.0 — Gratuit &amp; illimité",
      ...
      "news.r1Title": "Version 1.6.0",
      "news.r1Badge": "Actuelle",
      "news.r1Desc": "À partir de la version 1.6.0, les restrictions pour l'usage privé ont été levées. Nous sommes heureux de mettre désormais notre produit à la disposition des plus de <strong class=\"font-semibold\">10 000 utilisateurs de WirthSim</strong> dans le monde, sans aucune restriction.",
      ...
      "download.cardSub": "Version 1.6.0 · Logiciel gratuit",
      "download.statVersionLabel": "Version",
    ...
    it: {
      ...
      "nav.news": "Novità",
      "nav.download": "Download",
      "hero.badge": "Versione 1.6.0 — Gratuito e illimitato",
      ...
      "news.r1Title": "Versione 1.6.0",
      "news.r1Badge": "Attuale",
      "news.r1Desc": "A partire dalla versione 1.6.0 sono state rimosse le restrizioni per l'uso privato. Siamo lieti di mettere ora il nostro prodotto a disposizione degli oltre <strong class=\"font-semibold\">10.000 utenti di WirthSim</strong> nel mondo, senza alcuna limitazione.",
      ...
      "download.cardSub": "Versione 1.6.0 · Software gratuito",
    ...
    ru: {
      ...
      "hero.badge": "Версия 1.6.0 — Бесплатно и без ограничений",
      ...
      "news.r1Title": "Релиз 1.6.0",
      "news.r1Badge": "Актуально",
      "news.r1Desc": "Начиная с релиза 1.6.0 сняты ограничения для частного использования. Мы рады предоставить наш продукт без ограничений более чем <strong class=\"font-semibold\">10 000 пользователям WirthSim</strong> по всему миру.",
      ...
      "download.cardSub": "Версия 1.6.0 · Бесплатное ПО",
    ...
    zh: {
      ...
      "news.r1Title": "版本 1.6.0",
      "news.r1Badge": "最新",
      "news.r1Desc": "从版本 1.6.0 起，已取消对个人使用的限制。我们很高兴现在能够向全球超过 <strong class=\"font-semibold\">10,000 名 WirthSim 用户</strong> 无限制地提供我们的产品。",
      "news.r2Title": "全球应用",
      ...
      "download.cardSub": "版本 1.6.0 · 免费软件",
